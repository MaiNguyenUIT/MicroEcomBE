...
import com.example.cart_service.cache.ProductClientCacheWrapper;
...
public class CartService implements com.example.cart_service.service.Service.CartService {
    ...
    @Autowired
    private ProductClientCacheWrapper productClientCacheWrapper;
    ...
    public Cart addItemToUserCart(CartItemDTO cartItemDTO) {
        ...
        ProductDTO product = productClientCacheWrapper.getProductById(cartItemDTO.getProductId());
    ...
    public CartResponse getCartByUserId() {
        ...
        List<String> productIds = cart.getCartItems().stream()
                ...
                .distinct()
                .toList();
        List<ProductDTO> productDTOS = productClientCacheWrapper.getProductsByIds(productIds);
